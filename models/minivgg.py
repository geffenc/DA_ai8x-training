...
'''
Backbone for classifier trained using SSL
'''
...
def classifierbackbonenet(pretrained=False, **kwargs):
    """
    Constructs a CNN Model for SS pretraining
    """
    assert not pretrained
    return ClassifierBackbone(**kwargs)
